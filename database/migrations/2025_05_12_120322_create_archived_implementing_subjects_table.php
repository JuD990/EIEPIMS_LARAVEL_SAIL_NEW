...
return new class extends Migration
{
    ...
    {
        Schema::create('archived_implementing_subjects', function (Blueprint $table) {
            $table->id('archived_implementing_subject_id');
    ...
    {
        Schema::dropIfExists('archived_implementing_subjects');
    }
};
